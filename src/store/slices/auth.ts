...
const authSlice = createSlice({
  ...
  reducers: {
    ...
    initialize: (state, action: PayloadAction<{ isLoggedIn: boolean; user: User | null }>) => {
...
export const { setCurrentRole, clearError, loginSuccess, logout, initialize } = authSlice.actions;
