    ...
    <Stack spacing={2}>
      ...
      {headersNotDetected && (
        ...
        >
          ...
          {headerReasons.length > 0 ? ` (${headerReasons.join('; ')})` : ''}. Sample values below
          show what each column actually contains — if the first row of your file is a header,
          use the button to re-read it.
        </Alert>
      )}
