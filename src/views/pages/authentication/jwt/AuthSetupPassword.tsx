...
export default function AuthSetupPassword({ ...others }: { link?: string }) {
  ...
  return (
    <Formik
      ...
      onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
        if (!token) {
          setErrors({ submit: 'Invalid setup token' });
          return;
        }
      ...
      {({ errors, handleBlur, handleChange, handleSubmit, isSubmitting, touched, values }) => (
        <form noValidate onSubmit={handleSubmit} {...others}>
          <FormControl fullWidth error={Boolean(touched.password && errors.password)} sx={{ ...theme.typography.customInput }}>
            <InputLabel htmlFor="outlined-adornment-password-setup">Password</InputLabel>
            <OutlinedInput
              id="outlined-adornment-password-setup"
          ...
          {touched.password && errors.password && (
            <FormControl fullWidth>
              <FormHelperText error id="standard-weight-helper-text-setup">
                {errors.password}
              </FormHelperText>
            </FormControl>
          )}
          ...
          >
            <InputLabel htmlFor="outlined-adornment-confirm-password-setup">Confirm Password</InputLabel>
            <OutlinedInput
              id="outlined-adornment-confirm-password-setup"
          ...
          {touched.confirmPassword && errors.confirmPassword && (
            <FormControl fullWidth>
              <FormHelperText error id="standard-weight-helper-text-confirm-password-setup">
                {' '}
