...
import { VENDOR_FIELD_CONFIGS } from 'utils/vendorUtils';
...
const getFieldLabel = (field: string): string => {
  const config = VENDOR_FIELD_CONFIGS.find((c) => c.key === field);
  return config ? config.label : field.replace(/_/g, ' ').toUpperCase();
};
          ...
          <Table size="small">
            <TableHead>
              <TableRow>
                ...
                <TableCell width="40%">File Column</TableCell>
